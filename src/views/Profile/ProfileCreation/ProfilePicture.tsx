...
const ProfilePicture: React.FC = () => {
        ...
        return (
            <>
                ...
                <Text bold fontSize="20px" mb="24px">
                    {t('We couldn’t find any Mushu Collectibles in your wallet.')}
                </Text>
                <Text as="p">
                    {t(
                        'You need a MUSHU Collectible to finish setting up your profile. If you sold or transferred your starter collectible to another wallet, you’ll need to get it back or acquire a new one somehow. You can’t make a new starter with this wallet address.',
                    )}
                </Text>
            </>
        )
    ...
    return (
        <>
            ...
            <NextStepButton onClick={actions.nextStep}
