...
import {Box, Flex, Skeleton, Text} from 'uikit'
            ...
            <Inner>
                ...
                <Flex justifyContent="space-between" mt="8px">
                    <StyledVolumeFlex>
                        {secondTeam ? (
                            <StyledVolumeText
                                bold>${localiseTradingVolume(secondTeam.leaderboardData.volume)}</StyledVolumeText>
                        ) : (
                    ...
                    <StyledVolumeFlex>
                        {firstTeam ? (
                            <StyledVolumeText
                                bold>${localiseTradingVolume(firstTeam.leaderboardData.volume)}</StyledVolumeText>
                        ) : (
                            <Skeleton width="77px" height="24px"/>
                        )}
                        <Text fontSize="12px" color="textSubtle">
                    ...
                    <StyledVolumeFlex>
                        {thirdTeam ? (
                            <StyledVolumeText
                                bold>${localiseTradingVolume(thirdTeam.leaderboardData.volume)}</StyledVolumeText>
                        ) : (
                            <Skeleton width="77px" height="24px"/>
                        )}
                        <Text fontSize="12px" color="textSubtle">
