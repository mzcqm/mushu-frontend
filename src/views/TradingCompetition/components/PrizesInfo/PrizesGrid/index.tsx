...
import easterPrizes, {Rank, Tiers} from 'config/constants/trading-competition/easter'
                    ...
                    {rows.map((row) => {
                        ...
                        return (
                            <tr key={row.rank}>
                                ...
                                <Td>{row.hasNft ? <CheckmarkCircleIcon color="success"/> :
                                    <BlockIcon color="textDisabled"/>}</Td>
                            </tr>
                        )
                    })}
                    </tbody>
