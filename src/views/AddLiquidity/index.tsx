...
import {AddIcon, Button, CardBody, Flex, Message, Text, useModal} from 'uikit'
    ...
    const handleCurrencyBSelect = useCallback(
        (currencyB_: Currency) => {
            ...
            if (currencyIdA === newCurrencyIdB) {
                ...
                history.push(`/add/${currencyIdA || 'RNA'}/${newCurrencyIdB}`)
            }
        },
                            ...
                            <ColumnCenter>
                                <Message variant="warning">
                                    <div>
                                        ...
                                        <Text
                                            mb="8px">{t('The ratio of tokens you add will set the price of this pool.')}</Text>
