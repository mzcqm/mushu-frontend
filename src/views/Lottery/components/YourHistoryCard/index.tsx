...
import {ArrowBackIcon, Box, Card, CardBody, CardFooter, CardHeader, Flex, Heading, Skeleton, Text,} from 'uikit'
                ...
                <StyledCardBody>
                    <Box maxWidth="280px">
                        <Flex alignItems="center" justifyContent="center" mb="16px">
                            <WhiteBunny height="24px" mr="8px"/> <Text
                            textAlign="left">{t('No lottery history found')}</Text>
                        </Flex>
                        <Text textAlign="center" color="textSubtle" mb="16px">
