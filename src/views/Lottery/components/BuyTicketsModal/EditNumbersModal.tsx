...
import {ArrowBackIcon, AutoRenewIcon, Button, Flex, Modal, Text} from 'uikit'
    ...
    return (
        ...
        >
            <ScrollableContainer>
                ...
                <Button disabled={isConfirming} mb="16px" variant="secondary" width="100%" height="32px"
                        onClick={randomize}>
                    {t('Randomize')}
                </Button>
                {tickets.map((ticket) => (
            ...
            <Flex flexDirection="column" justifyContent="center" m="24px">
                ...
                <Button mt="8px" variant={isConfirming ? 'secondary' : 'text'} disabled={isConfirming}
                        onClick={onDismiss}>
                    <ArrowBackIcon color={isConfirming ? 'disabled' : 'primary'} height="24px"
                                   width="24px"/> {t('Go back')}
                </Button>
            </Flex>
        </StyledModal>
    )
