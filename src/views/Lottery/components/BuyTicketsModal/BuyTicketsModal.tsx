...
import {ArrowForwardIcon, BalanceInput, Button, Flex, HelpIcon, Modal, Skeleton, Text, Ticket, useTooltip,} from 'uikit'
    ...
    return (
        <StyledModal title={t('Buy Tickets')} onDismiss={onDismiss}
            ...
            <Flex flexDirection="column">
                ...
                <Flex borderTop={`1px solid ${theme.colors.cardBorder}`} pt="8px" mb="24px"
