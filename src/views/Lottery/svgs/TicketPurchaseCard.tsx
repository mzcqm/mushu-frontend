        ...
        <Svg viewBox="0 0 296 121" {...props}>
            <g filter="url(#filter0_dd_ticket_purchase_card)">
                ...
                <path
                    ...
                    fill="#FFB237"
                />
                <path d="M90 0H276C284.837 0 292 7.16344 292 16V97C292 105.837 284.837 113 276 113H90V0Z"
                      fill="#FFB237"/>
            </g>
            <defs>
                <filter
                ...
                >
                    ...
                    />
                    <feBlend mode="normal" in="SourceGraphic" in2="effect2_dropShadow_ticket_purchase_card"
                             result="shape"/>
                </filter>
            </defs>
        </Svg>
