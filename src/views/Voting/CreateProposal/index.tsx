import React, {ChangeEvent, FormEvent, lazy, useEffect, useMemo, useState} from 'react'
import {
    AutoRenewIcon,
    Box,
    Breadcrumbs,
...
import {generateMetaData, generatePayloadData, Message, sendSnaphotData} from '../helpers'
                            ...
                            <CardBody>
                                ...
                                {account ? (
                                    <>
                                        ...
                                        <Button scale="sm" type="button" variant="text"
                                                onClick={onPresentVoteDetailsModal} p={0}>
