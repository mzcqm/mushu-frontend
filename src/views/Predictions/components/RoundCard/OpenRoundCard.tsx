...
import {ArrowDownIcon, ArrowUpIcon, Button, CardBody, PlayCircleOutlineIcon, useTooltip} from 'uikit'
...
const OpenRoundCard: React.FC<OpenRoundCardProps> = ({
    ...
    const getPositionEnteredIcon = () => {
        return position === BetPosition.BULL ? <ArrowUpIcon color="currentColor"/> :
